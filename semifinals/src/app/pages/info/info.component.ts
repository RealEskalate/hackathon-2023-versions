...
export class InfoComponent {
  ...
  steps = [
    {number: '4', title: "Semifinals",description: "Continued guidance from advisors help refine and optimize the projects of the remaining teams. This phase is marked by iterative feedback and project refinement.",  date: 'September 19 - October 28, 2023 23:59 (EAT)', final: false},
    {number: '3', title: "Quarterfinals",description: "Participants undertake a 50-hour virtual hackathon, competing for a place among the top 30 projects and receiving expert mentorship along the way.",  date: '1-3 September, 2023 - 11:00 AM (EAT)', final: false},
