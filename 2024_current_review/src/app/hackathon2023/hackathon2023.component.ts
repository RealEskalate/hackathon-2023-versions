...
@Component({
  selector: 'app-hackathon2023',
  templateUrl: './hackathon2023.component.html',
  styleUrls: ['./hackathon2023.component.css']
})
export class Hackathon2023Component implements OnInit, OnDestroy  {
