...
export class InfoComponent {
  ...
  steps = [
    {number: '1', title: "Registration",description: "Students to register for the African-wide hackathon focused on Generative AI.",  date: "1-30 August, 2023", final: false},
